  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
        ...
        "datePublished":"2026-06-01","dateModified":"2026-09-01"
      })}} />
        ...
        <section>
          ...
          <div className="table-responsive">
            <table>
              ...
              <tbody>
                <tr><td className="font-bold">삼성카드</td><td><span className="badge-discount">7%</span></td><td>이탈리아·말레이시아·인도네시아 10%</td><td>2026.09.30</td><td>신용카드</td><td className="text-xs">LINK 혜택/전용 페이지</td></tr>
                <tr><td className="font-bold">신한카드</td><td><span className="badge-discount">7%</span></td><td>말레이시아·인도네시아·이탈리아 10%</td><td>2026.09.30</td><td>신용카드</td><td className="text-xs">선착순 자동적용</td></tr>
                <tr><td className="font-bold">우리카드</td><td><span className="badge-discount">7%</span></td><td>—</td><td>2026.09.30</td><td>신용카드</td><td className="text-xs">핀번호 입력</td></tr>
                <tr><td className="font-bold">하나카드</td><td><span className="badge-discount">7%</span></td><td>—</td><td>2026.09.30</td><td>신용카드</td><td className="text-xs">선착순 마감</td></tr>
                <tr><td className="font-bold">현대카드</td><td><span className="badge-discount">7%</span></td><td>최대 10%</td><td>2026.09.30</td><td>신용카드</td><td className="text-xs">—</td></tr>
                ...
                <tr><td className="font-bold">NH농협카드</td><td><span className="badge-discount">7%</span></td><td>말레이시아·스페인·이탈리아 10%</td><td>2026.09.30</td><td>신용+체크</td><td className="text-xs badge-success">체크카드 가능!</td></tr>
