  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
        ...
        "@type": "WebPage",
        "name": "아고다 쿠폰",
        "description": "9월 아고다 쿠폰 총정리! 국내·일본 아고다 할인코드부터 아고다 할인링크까지 한 번에. 지금 바로 쓸 수 있는 아고다 쿠폰 모음, 9월 숙소 예약 전 할인코드 사용해서 예약하세요. 매월 업데이트되는 최신 할인 정보입니다.",
      ...
      <div className="container py-12 space-y-16">
        ...
        {/* 기본 할인코드 */}
        <section>
          <h2 className="section-title">2026년 9월 아고다 할인코드</h2>
          <p className="text-sm text-muted-foreground mt-8 mb-6">⚠️ 아래 할인코드는 2026년 9월 기준이며, 매월 말~익월 초에 갱신됩니다.</p>
        ...
        {/* 카드사 제휴 할인 */}
        <section>
          <h2 className="section-title">2026년 9월 카드사 제휴 할인 프로모션</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { name: "삼성카드", rate: "7~10%", detail: "전 지역 7% / 이탈리아·말레이시아·인도네시아 10%", period: "~2026.09.30", note: "LINK 혜택 또는 전용 페이지" },
              { name: "신한카드", rate: "7~10%", detail: "전 지역 7% / 말레이시아·인도네시아·이탈리아 10%", period: "~2026.09.30", note: "선착순 자동 적용" },
              { name: "우리카드", rate: "7%+", detail: "전 지역 최소 7% 이상 할인", period: "~2026.09.30", note: "핀번호 입력 시 자동 적용" },
              { name: "하나카드", rate: "7%+", detail: "전 지역 최소 7% 이상 할인", period: "~2026.09.30", note: "선착순 마감" },
              { name: "현대카드", rate: "7~10%", detail: "전 지역 최소 7% / 최대 10%", period: "~2026.09.30", note: "" },
              { name: "KB국민카드", rate: "7~10%", detail: "전 지역 7% / 특정 지역 10%", period: "확인 필요", note: "" },
              { name: "NH농협카드", rate: "7~10%", detail: "전 지역 7% / 말레이시아·스페인·이탈리아 10%", period: "~2026.09.30", note: "체크카드도 가능!" },
        ...
        <section>
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-4">
            ...
            <div className="info-card">
              ...
              <span className="badge-discount mb-2">11% 할인</span>
              <p className="text-sm text-muted-foreground mt-2">국내·해외 숙소 11% 할인 · 최대 100 USD · 예약 9.1~9.30 / 투숙 ~10.31 · 전용 페이지 결제</p>
        ...
        <section>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="info-card">
              ...
              <p className="text-sm text-muted-foreground mt-2">2026년 9월 30일까지 · 여름 시즌 한정 프로모션</p>
            </div>
          </div>
        </section>
