# 블로그 폴더 설명 (agd.couponmonster.co.kr)
...
주소는 `https://agd.couponmonster.co.kr/blog/agoda-coupon/` 가 됩니다.
...
| `{{canonical}}` | 글의 정식 주소 | https://agd.couponmonster.co.kr/blog/agoda-coupon/ |
...
- 포인트 색: **#3B5BDB** (indigo) — `blog.css` 맨 위 `--blog-point`
